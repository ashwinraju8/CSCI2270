...
///////////////////////////////////////////////////////////////
        ...
        if(dataSet == 0)
        {
            ...
            outputName = "insert_search_ performance_hash_linear_dataSetA.csv";
        }
        else
        {
            inputName = "dataSetB-updated.csv";
            outputName = "insert_search_ performance_hash_linear_dataSetB.csv";
        }
...
///////////////////////////////////////////////////////////////
        ...
        for(int k = 0; k < 100; k++) // outer for loop to iterate every 100 inserts/searches
        {
            ...
            */
            ...
            {
                hl.insertItem(testData[i]); // insert the indexed element into hash table
            }
            first = last;
            ...
            numInsertCollisions[k] = hl.getNumOfCollision() - currCollisions;
            currCollisions = hl.getNumOfCollision();
            ...
            */
            ...
            for(int i = 0; i < 100; i++)
            {
                searchResult = hl.searchItem(testData[randomIDX[i]]); // search for indexed element
            }
            ...
            numSearchCollisions[k] = hl.getNumOfCollision() - currCollisions;
            currCollisions = hl.getNumOfCollision();
        }
