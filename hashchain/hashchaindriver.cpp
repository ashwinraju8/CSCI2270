...
///////////////////////////////////////////////////////////////
        ...
        if(dataSet == 0)
        {
            ...
            outputName = "insert_search_ performance_hash_chain_dataSetA.csv";
        }
        else
        {
            inputName = "dataSetB-updated.csv";
            outputName = "insert_search_ performance_hash_chain_dataSetB.csv";
        }
...
///////////////////////////////////////////////////////////////
        ...
        for(int k = 0; k < 100; k++) // outer for loop to iterate every 100 inserts/searches
        {
            ...
            */
            ...
            {
                hc.insertItem(testData[i]); // insert the indexed element into hash table
            }
            first = last;
            ...
            numInsertCollisions[k] = hc.getNumOfCollision() - currCollisions;
            currCollisions = hc.getNumOfCollision();
            ...
            */
            ...
            for(int i = 0; i < 100; i++)
            {
                searchResult = hc.searchItem(testData[randomIDX[i]]); // search for indexed element
            }
            ...
            numSearchCollisions[k] = hc.getNumOfCollision() - currCollisions;
            currCollisions = hc.getNumOfCollision();
        }
