...
///////////////////////////////////////////////////////////////
        ...
        if(dataSet == 0)
        {
            ...
            outputName = "insert_search_ performance_BST_dataSetA.csv";
        }
        else
        {
            inputName = "dataSetB-updated.csv";
            outputName = "insert_search_ performance_BST_dataSetB.csv";
        }
...
///////////////////////////////////////////////////////////////
        ...
        for(int k = 0; k < 100; k++)   // outer for loop to iterate every 100 inserts/searches
        {
            ...
            */
            ...
            {
                bst.insertNode(testData[i]);  // insert the indexed element into linked list
            }
            first = last;
            ...
            */
            ...
            for(int i = 0; i < 100; i++)
            {
                searchResult = bst.search(testData[randomIDX[i]]); // search for indexed element
            }
